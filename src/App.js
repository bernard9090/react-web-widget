...

                            {
                                singleServiceDetails !== null ?
                                    <p ref={this.testFadeIn} className={"en_info"}>
                                        Get {singleServiceDetails && singleServiceDetails.name} content directly to your phone {singleServiceDetails &&  singleServiceDetails.tariffs ? `@ Ghs ${singleServiceDetails && singleServiceDetails.tariffs[`${this.state.smsc}`]}/${singleServiceDetails.billingCycle}` : "."}
                                    </p>:
                                    <p ref={this.testFadeIn} className={"en_info"}>
